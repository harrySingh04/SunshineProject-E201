...
public class MainActivity extends AppCompatActivity {
    ...
    {
        String currnetLoc = SunshinePreferences.getPreferredWeatherLocation(this);
        WeatherNetworkTask netTask = new WeatherNetworkTask();
        netTask.execute(currnetLoc);
    }

    // TODO (5) Create a class that extends AsyncTask to perform network requests

    class WeatherNetworkTask extends AsyncTask<String,Void,String[]> {
